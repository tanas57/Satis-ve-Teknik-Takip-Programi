...
namespace By_Tayo
{
    public partial class SatisAylik : Form
    {
        public SatisAylik()
        {
            InitializeComponent();
        ...
        private void SatisAylik_Load(object sender, EventArgs e)
        {
            ...
            DateTime tarih22 = DateTime.Now.AddMonths(-1);
            ...
            if (SatisSonuc != null)
            {
                ...
                istatislik.Titles.Add("Aylık Satış Raporu Grafik");
            ...
            {
                MessageBox.Show("Aylık olarak şuana kadar satış yapılmamıştır. (R-03)", "Bilgilendirme");
                this.Close();
            }
        }
    }
